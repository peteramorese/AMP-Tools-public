...
class HW8 {
    public:
        ...
        /// @return Multi-agent problem
        static amp::MultiAgentProblem2D getWorkspace1();
        ...
        //static int grade(const std::string& email, int argc, char** argv, 
        //            const _C_MA_CTOR_ARGS_TUP& prm_ctor_args_tuple,
        //            const _DC_MA_CTOR_ARGS_TUP& rrt_ctor_args_tuple);
    private:
