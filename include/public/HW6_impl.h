...
int amp::HW6::grade(const std::string& email, int argc, char** argv) {
    ampprivate::_PointWFReconstructor<POINT_WF_ALG_T, std::tuple<>> reconstructor_point_wf_algo(std::tuple<>{});
    ampprivate::_ManipWFReconstructor<MANIP_WF_ALG_T, std::tuple<>> reconstructor_manip_wf_algo(std::tuple<>{});
    ampprivate::_AStarReconstructor<ASTAR_ALG_T, std::tuple<>> reconstructor_astar_algo(std::tuple<>{});
...
int amp::HW6::grade(const std::string& email, int argc, char** argv, const _POINT_CTOR_ARGS_TUP& point_wf_ctor_args_tuple, const _MANIP_CTOR_ARGS_TUP& manip_wf_ctor_args_tuple, const _ASTAR_CTOR_ARGS_TUP& astar_ctor_args_tuple) {
    ampprivate::_PointWFReconstructor<POINT_WF_ALG_T, _POINT_CTOR_ARGS_TUP> reconstructor_point_wf_algo(point_wf_ctor_args_tuple);
    ampprivate::_ManipWFReconstructor<MANIP_WF_ALG_T, _MANIP_CTOR_ARGS_TUP> reconstructor_manip_wf_algo(manip_wf_ctor_args_tuple);
    ampprivate::_AStarReconstructor<ASTAR_ALG_T, _ASTAR_CTOR_ARGS_TUP> reconstructor_astar_algo(astar_ctor_args_tuple);
    return grade(reconstructor_point_wf_algo, reconstructor_manip_wf_algo, reconstructor_astar_algo, email, argc, argv);
}
